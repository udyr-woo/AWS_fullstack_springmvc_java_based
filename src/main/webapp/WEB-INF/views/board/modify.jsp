	...
	<div class="card shadow mb-4">
		...
		<div class="card-body">
			...
			<div class="form-group">
				...
				<textarea rows="10" class="form-control" placeholder="Enter content" id="comment" name="content">${board.content}</textarea>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				...
				<div class="uploadResult my-3">
					<ul class="list-group filenames my-3">
						...
						<a href="/download${attach.url}&thumb=off"><i class="far fa-file"></i> ${attach.name}</a> 
						<i class="far fa-times-circle btn-remove float-right" data-file="${attach.url}" data-uuid="${attach.uuid}"></i> 
						</li> 					
						</c:if>
						</c:forEach>
					</ul>
			...
			<button class="btn btn-outline-danger" formaction="remove">remove</button>
			</sec:authorize>
